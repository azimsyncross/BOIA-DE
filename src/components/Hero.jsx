...
const content = {
  hero: {
    title: "Ignite Your Brand's Growth with BOIA DE",
    subtitle:
      "Drive impactful results with targeted digital advertising, SEO strategies that elevate your site, and ASO that makes your app stand out. Let BOIA DE propel your brand across Google, Facebook, Instagram, and beyond!",
