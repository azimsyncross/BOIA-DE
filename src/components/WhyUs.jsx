...
const WhyUs = () => {
  const content = {
    header: {
      ...
      subtitle:
        "Discover why top brands trust BOIA DE for their SEO, ASO, and advertising needs",
    },
    slides: [
      {
        ...
        content:
          "BOIA DE helps you create high-impact ad campaigns across YouTube, Facebook, Instagram, and TikTok, engaging your target audience and driving conversions with tailored digital advertising strategies.",
      ...
      },
      {
        ...
        content:
          "With BOIA DE&apos;s ASO strategies, we ensure your app ranks higher in app stores, optimizing listings, keywords, and visuals to increase downloads and user engagement.",
      ...
      },
      {
        ...
        content:
          "Whether it&apos;s improving SEO for your website or optimizing ASO for your app, BOIA DE offers personalized strategies designed for sustainable growth and long-term success.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 mb-6">
            ...
            <span className="text-sm text-indigo-300">Why Choose BOIA DE</span>
          </div>
