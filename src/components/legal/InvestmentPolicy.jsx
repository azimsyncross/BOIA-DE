  ...
  const policyData = [
    {
      ...
      description:
        "At BOIA DE LLC, we are committed to delivering exceptional service quality and ensuring client satisfaction. Our investment policy is designed to be fair and transparent while recognizing the specialized nature of strategic digital marketing services.",
      points: [
